...
- Chọn tab **Import** (Nhập), nhấn nút chọn tệp và chọn tệp `warehouse_manager.sql` trong thư mục dự án để khởi tạo các bảng dữ liệu (`danhmuc`, `sanpham`, `users`, `sessions`).
...
├── warehouse_manager.sql   # File SQL khởi tạo CSDL mẫu ban đầu
├── assets/
│   ├── css/
